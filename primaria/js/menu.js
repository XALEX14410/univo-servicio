...
// Base para las rutas
const inicio = "/univo-servicio/primaria";

const basePath = "/univo-servicio/primaria/src";
    ...
    [
        {
            ...
            enlace: "#",
            submenus: [
                { texto: "Alumnos", enlace: "https://sise.univo.edu.mx/WEB2/SISE/WebPrimaria/SisePrimaria/Autenticacion.php", target: "_blank" },
                { texto: "Docentes UniVO", enlace: "https://sise.univo.edu.mx/WEB2/SISE/DocentesPrimaria/Autenticacion.php", target: "_blank" }
            ]
        },
