...
const contacts = [
    ...
    {
        title: "Subdirección",
        emails: ["nghernandez@correo.univo.edu.mx"],
        phones: {
            fijo: [],
            whatsapp: []
        }
    ...
    },
    {
        ...
        emails: ["mvillazcan@correo.univo.edu.mx"],
        phones: {
            fijo: [],
            whatsapp: []
        }
    },
    {
        ...
        emails: ["mgalan@correo.univo.edu.mx"],
        phones: {
            fijo: [],
            whatsapp: []
        }
