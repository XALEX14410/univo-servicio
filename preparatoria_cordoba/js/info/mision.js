document.addEventListener('DOMContentLoaded', function () {
    const contenido = [
        {
            title: "Misión",
            description: "Bachillerato Valle de Orizaba es una institución privada del nivel medio superior que participa en la                formación integral de sus estudiantes, promoviendo armónicamente el desarrollo de sus competencias                genéricas y disciplinares, siempre comprometidos con su entorno y capaces de enfrentar con éxito los                retos que la vida les presente..",
            // images: [
