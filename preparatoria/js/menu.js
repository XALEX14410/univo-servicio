...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (logoContainer && !logoContainer.querySelector("img")) {
        logoContainer.innerHTML = `
            <img src="/univo-servicio/preparatoria/img/logo_prepa.png" alt="Logo escolar" class="logo" id="logo1">
    ...
    if (logoContainerMax && !logoContainerMax.querySelector("img")) {
        logoContainerMax.innerHTML = `
            <img src="/univo-servicio/preparatoria/img/logo_prepa.png" alt="Logo escolar" class="logo">
            <a href="/univo-servicio/principal/index.html">
                <img src="/univo-servicio/preparatoria/img/GEU2030-50.png" alt="Logo de la Empresa" class="logo">
            </a>
        `;
    }
});
...
const basePath = "/univo-servicio/preparatoria/src";
